  ...
  $(document).ready(function () {
    ...
    var bouData = {
      ...
      datasets: [{
        ...
        label: 'Past Two Month',
        fill: 'start',
        data: [280, 410, 420, 260, 420, 340, 572, 719, 321, 429, 600, 803, 101, 280, 791, 620, 700, 400, 130, 302, 720, 980, -89, 410, 300, 530, 630, 720, 780, 1200],
        backgroundColor: 'rgba(100,255,105,0.1)',
        borderColor: 'rgba(255,65,105,1)',
        pointBackgroundColor: '#ffffff',
        pointHoverBackgroundColor: 'rgba(255,200,250,1)',
        borderDash: [3, 3],
        borderWidth: 1,
        pointRadius: 0,
        pointHoverRadius: 2,
